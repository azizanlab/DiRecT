...
N_EXPS_IN_PARALLEL = 2 if not USE_CUDA else 1

N_CORES = N_EXPS_IN_PARALLEL
# N_CORES = 8
MEMORY_SINGLE_JOB = 12000
MEMORY_PER_CORE = N_EXPS_IN_PARALLEL * MEMORY_SINGLE_JOB // N_CORES
PARTITION = 'YOUR_GPU_PARTITION' if USE_CUDA else 'YOUR_CPU_PARTITION'  ### Adjust to your cluster
GRES = 'gpu:1' if USE_CUDA else None  # e.g. gpu:v100:1, gpu:rtx3090:1, gpu:a5000:1
