...
_cli = argparse.ArgumentParser(description="Visualize a generated trajectory dataset.")
_cli.add_argument("--data-dir", required=True,
                  help="Path to the dataset directory (must contain args.yaml and metadata.yaml).")
DATA_DIR = _cli.parse_args().data_dir
